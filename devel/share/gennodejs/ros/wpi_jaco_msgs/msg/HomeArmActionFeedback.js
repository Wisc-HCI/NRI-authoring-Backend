...
class HomeArmActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new HomeArmFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = HomeArmFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HomeArmActionFeedback(null);
    ...
    data.feedback = HomeArmFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HomeArmActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = HomeArmFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new HomeArmFeedback()
    }
...
module.exports = HomeArmActionFeedback;
