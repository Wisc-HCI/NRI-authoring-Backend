...
class HomeArmActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = HomeArmResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HomeArmActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = HomeArmResult.Resolve(msg.result)
    }
    else {
      resolved.result = new HomeArmResult()
    }
...
module.exports = HomeArmActionResult;
