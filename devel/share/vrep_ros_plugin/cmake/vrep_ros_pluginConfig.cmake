...
if("TRUE" STREQUAL "TRUE")
  set(vrep_ros_plugin_SOURCE_PREFIX /home/jerry/Desktop/therbligs_ws/src/vrep_ros_bridge/vrep_ros_plugin)
  set(vrep_ros_plugin_DEVEL_PREFIX /home/jerry/Desktop/therbligs_ws/devel)
  ...
  set(vrep_ros_plugin_INSTALL_PREFIX /home/jerry/Desktop/therbligs_ws/install)
...
if(NOT "/home/jerry/Desktop/therbligs_ws/src/vrep_ros_bridge/vrep_ros_plugin/include " STREQUAL " ")
  set(vrep_ros_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/home/jerry/Desktop/therbligs_ws/src/vrep_ros_bridge/vrep_ros_plugin/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'vrep_ros_plugin' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'vrep_ros_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jerry/Desktop/therbligs_ws/src/vrep_ros_bridge/vrep_ros_plugin/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${vrep_ros_plugin_dep}_FOUND)
      find_package(${vrep_ros_plugin_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${vrep_ros_plugin_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
