...
if("TRUE" STREQUAL "TRUE")
  set(quadrotor_handler_SOURCE_PREFIX /home/jerry/Desktop/therbligs_ws/src/vrep_ros_bridge/quadrotor_handler)
  set(quadrotor_handler_DEVEL_PREFIX /home/jerry/Desktop/therbligs_ws/devel)
  ...
  set(quadrotor_handler_INSTALL_PREFIX /home/jerry/Desktop/therbligs_ws/install)
...
if(NOT "/home/jerry/Desktop/therbligs_ws/src/vrep_ros_bridge/quadrotor_handler/include " STREQUAL " ")
  set(quadrotor_handler_INCLUDE_DIRS "")
  set(_include_dirs "/home/jerry/Desktop/therbligs_ws/src/vrep_ros_bridge/quadrotor_handler/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'quadrotor_handler' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'quadrotor_handler' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jerry/Desktop/therbligs_ws/src/vrep_ros_bridge/quadrotor_handler/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${quadrotor_handler_dep}_FOUND)
      find_package(${quadrotor_handler_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${quadrotor_handler_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
