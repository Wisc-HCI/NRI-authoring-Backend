...
if(NOT "/home/jerry/Desktop/therbligs_ws/src/vrep_ros_bridge/rigid_body_handler/include " STREQUAL " ")
  set(rigid_body_handler_INCLUDE_DIRS "")
  set(_include_dirs "/home/jerry/Desktop/therbligs_ws/src/vrep_ros_bridge/rigid_body_handler/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rigid_body_handler' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rigid_body_handler' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jerry/Desktop/therbligs_ws/src/vrep_ros_bridge/rigid_body_handler/${idir}'.  ${_report}")
    endif()
