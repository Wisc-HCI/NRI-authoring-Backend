...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_5B().pack(_x.retract, _x.retractPosition.position, _x.retractPosition.armCommand, _x.retractPosition.fingerCommand, _x.retractPosition.repeat))
      ...
      buff.write(_get_struct_h().pack(self.numAttempts))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.retract, _x.retractPosition.position, _x.retractPosition.armCommand, _x.retractPosition.fingerCommand, _x.retractPosition.repeat,) = _get_struct_5B().unpack(str[start:end])
      ...
      (self.numAttempts,) = _get_struct_h().unpack(str[start:end])
      return self
