...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4B().pack(_x.position, _x.armCommand, _x.fingerCommand, _x.repeat))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.position, _x.armCommand, _x.fingerCommand, _x.repeat,) = _get_struct_4B().unpack(str[start:end])
