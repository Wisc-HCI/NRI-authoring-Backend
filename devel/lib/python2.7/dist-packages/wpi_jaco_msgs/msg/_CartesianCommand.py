...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4B6d().pack(_x.position, _x.armCommand, _x.fingerCommand, _x.repeat, _x.arm.linear.x, _x.arm.linear.y, _x.arm.linear.z, _x.arm.angular.x, _x.arm.angular.y, _x.arm.angular.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.position, _x.armCommand, _x.fingerCommand, _x.repeat, _x.arm.linear.x, _x.arm.linear.y, _x.arm.linear.z, _x.arm.angular.x, _x.arm.angular.y, _x.arm.angular.z,) = _get_struct_4B6d().unpack(str[start:end])
