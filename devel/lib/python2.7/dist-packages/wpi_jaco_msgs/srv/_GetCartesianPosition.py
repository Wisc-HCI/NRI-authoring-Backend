...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_6d().pack(_x.pos.linear.x, _x.pos.linear.y, _x.pos.linear.z, _x.pos.angular.x, _x.pos.angular.y, _x.pos.angular.z))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pos.linear.x, _x.pos.linear.y, _x.pos.linear.z, _x.pos.angular.x, _x.pos.angular.y, _x.pos.angular.z,) = _get_struct_6d().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
